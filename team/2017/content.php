...
class TeamGroup{
    ...
    function __construct($name, $id, $members){
        $this->name = $name;
        $this->id = $id;
...
$members = array(
    new TeamGroup("The Board", "the_board", array(
        new Member("Olaf Nornes Kvamsøy", "Team Leader", "photos2017/members/olaf_kvamsoy.jpg"),
        new Member("Helge Vassbakk", "Cheif Electrical Engineer", "photos2017/members/helge_vassbakk.jpg"),
        new Member("Joakim Sandanger Pettersen", "Cheif Mechanical Engineer", "photos2017/members/joakim_sandanger.jpg"),
        new Member("Truls Mentzoni Skoglund", "Supply Chain Manager", "photos2017/members/truls_mentzoni_skoglund.jpg"),
        new Member("Magnus Ljostveit", "Head of Finance", "photos2017/members/magnus_ljostveit.jpg"),
        new Member("Magne Årdal", "Head of Marketing", "photos2017/members/magne_ardal.jpg"),
        new Member("Olav Risa", "HMS", "photos2017/members/olav_risa.jpg"),
    )),
    new TeamGroup("Marketing", "marketing", array(
        new Member("Magne Årdal", "Head of Marketing", "photos2017/members/magne_ardal.jpg"),
        new Member("Jan Alexander Bjerke", "Media Manager", "photos2017/members/jan_alexander_bjerke.jpg"),
        new Member("Nora Fotland", "Sponsor Relations", "photos2017/members/nora_fotland.jpg"),
        new Member("Bente Egeland", "Sponsor Relations", "photos2017/members/bente_egeland.jpg"),
        new Member("Hanna Risinggård", "Event Manager", "photos2017/members/hanna_risinggard.jpg"),
        new Member("Trym Ullestad", "Blog and Magazine", "photos2017/members/trym_ullestad.jpg"),
    )),
    new TeamGroup("Monocoque", "monocoque", array(
        new Member("Philip Lundberg Jamissen", "Group leader", "photos2017/members/philip_lundberg_jamissen.jpg"),
        new Member("Joakim Sandanger Pettersen", "Monocoque design/SES", "photos2017/members/joakim_sandanger.jpg"),
        new Member("Kaja Sofie Lamvik", "Inserts", "photos2017/members/kaja_sofie_lamvik.jpg"),
        new Member("Karoline Kverneland", "Ergonomics", "photos2017/members/karoline_kverneland.jpg"),
        new Member("Marius Aasen", "Main and front hoop", "photos2017/members/marius_aasen.jpg"),
        new Member("Trygve Pollen", "Assembly", "photos2017/members/trygve_pollen.jpg"),
        new Member("Olaf Nornes Kvamsøy", "Monocoque production/SES", "photos2017/members/olaf_kvamsoy.jpg"),
    )),
    new TeamGroup("Suspension", "suspension", array(
        new Member("Truls Mentzoni Skoglund", "Group Leader", "photos2017/members/truls_mentzoni_skoglund.jpg"),
        new Member("Kristoffer Nielsen", "Drivetrain", "photos2017/members/kristoffer_nielsen.jpg"),
        new Member("Maren Lodden", "Dampers and ARB", "photos2017/members/maren_lodden.jpg"),
        new Member("Mia Katrin Risan", "Brakes and Pedalbox", "photos2017/members/mia-kathrin_risan.jpg"),
        new Member("Audun Brønseth", "Suspension", "photos2017/members/audun_bronseth.jpg"),
        new Member("Thea Emilie Finn", "Rims", "photos2017/ion_stig2.jpg"),
        new Member("Erik Benjamin Bruns", "Wheel Hub", "photos2017/members/erik_benjamin_bruns.jpg"),
        new Member("Tor Inge Berge", "Coach", "photos2017/members/tor_inge_berge.jpg"),
    )),
    new TeamGroup("Battery", "battery", array(
        new Member("Olav Risa", "Group Leader", "photos2017/members/olav_risa.jpg"),
        new Member("Helge Vassbakk", "BMS", "photos2017/members/helge_vassbakk.jpg"),
        new Member("Benjamin Kristoffer Risa Vik", "Accumulator Design", "photos2017/ion_stig2.jpg"),
    )),
    new TeamGroup("High Voltage", "high_voltage", array( 
        new Member("Anders Helle", "Big Boss", "photos2017/members/anders_helle.jpg"),
        new Member("Sebastian Stokholm Ravndal", "High Voltage system", "photos2017/members/sebastian_stokholm_ravndal.jpg"),
        new Member("Aleksander Ferkingstad", "Motorcontroller", "photos2017/ion_stig2.jpg"),
    )),
    new TeamGroup("Electronics", "electronics", array( 
        new Member("Svein Grøttå Ree", "Group Leader - ECU/Wire Harness/ Misc. electronics", "photos2017/members/svein_grotta_ree.jpg"),
        new Member("Tellef Goderstad Sunne", "ECU/Wire harness/ Misc. electronics", "photos2017/members/tellef_goderstad_sunne.jpg"),
        new Member("Stian Sagen", "TSAL/Shutdown Circuit", "photos2017/members/stian_sagen.jpg"),
        new Member("Fredrik Wigsnes Jensen", "μC-programming/ sensor analytics", "photos2017/members/fredrik_wigsnes.jpg"),
        new Member("Aleksander Ferkingstad", "Coach", "photos2017/ion_stig2.jpg"),
    )),
    new TeamGroup("Software", "software", array( 
        new Member("Nicolas Fløysvik", "Group Leader - Analytics software", "photos2017/members/nicolas_floysvik.jpg"),
        new Member("Hanna Risinggård", "Backend Developer", "photos2017/members/hanna_risinggard.jpg"),
        new Member("Trude Marie Sele", "Backend Developer", "photos2017/members/trude_marie_sele.jpg"),
        new Member("Alexander Lyon", "Frontend Developer", "photos2017/members/alexander_lyon.jpg"),
        new Member("Stian Trondsen", "Analytics software", "photos2017/members/stian_trondsen.jpg"),
        new Member("Fredrik Wigsnes Jensen", "μC-programming/ sensor analytics", "photos2017/members/fredrik_wigsnes.jpg"),
    )),
    new TeamGroup("Aerodynamic", "aerodynamic", array( 
        new Member("Marius Hansen", "Group Leader", "photos2017/members/marius_hansen.jpg"),
        new Member("Eivind Vinnes", "Sidepod Design", "photos2017/members/eivind vinnes.jpg"),
    )),
...
<?php for ($i = 0; $i < sizeof($members); $i++){
        ...
        <div id="<?php echo $curTeam->id ?>" class="group">
            <div class="group-line">
                <span><a class="image-link" href="#"><?php echo $curTeam->name ?></a></span>
            </div>
            <div class="row">
