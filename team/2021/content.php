...
new TeamGroup("The Board", "the_board","img/groups/the_board.jpg", array(
    new Member("Trygve Pollen", "Team Leader", "img/members/trygve_pollen.jpg"),
    new Member("Fredrik Rege", "Group Leader Administration", "img/members/ion_stig.jpg"),
    new Member("Erlend Røstbø", "Group Leader Mechanical", "img/members/erlend_rostbo.jpg"),
    new Member("Per Gundersen Lund", "Group Leader Electronics", "img/members/per_gundersen_lund.jpg")
)),
new TeamGroup("Administration", "administration","img/groups/administration.jpg", array(
    new Member("Fredrik Rege", "Group Leader Administration", "img/members/ion_stig.jpg"),
    new Member("Nasra Abdille", "Economics", "img/members/nasra_abdille.jpg"),
	new Member("Hisham Mohamed Abid", "Cost", "img/members/ion_stig.jpg"),
	new Member("Alf Martin Hammerstad", "Media", "img/members/alf_martin_hammerstad.jpg")
)),
new TeamGroup("Mechanical", "machanical", "img/groups/mechanical.jpg", array(
    new Member("Erlend Røstbø", "Group Leader Mechanical", "img/members/erlend_rostbo.jpg"),
    new Member("Anders Gard", "Chassis & SES", "img/members/anders_gard.jpg"),
    new Member("Martin Mildt", "Chassis", "img/members/martin_mildt.jpg"),
    new Member("Martin Larsen", "Steering System", "img/members/martin_larsen.jpg"),
    new Member("Olai Hagland", "Cooling System", "img/members/ion_stig.jpg"),
    new Member("Sondre Mikkelsen", "Suspension", "img/members/sondre_mikkelsen.jpg"),
    new Member("Lars Andreas Flesjå Genthner", "Suspension", "img/members/lars_andreas_flesjaa_genthner.jpg"),
    new Member("Sigurd Grøvdal Hansen", "Fiber Layup", "img/members/sigurd_grovdal_hansen.jpg"),
	new Member("Åse Marie Pettersen", "Ergonomics", "img/members/aase_marie_pettersen.jpg"),
    new Member("Vegard Bror Trodal", "Mentor", "img/members/ion_stig.jpg")
)),
new TeamGroup("Electronics", "Electronics","img/groups/electronics.jpg", array(
    new Member("Per Gundersen Lund", "Group Leader Electronics", "img/members/per_gundersen_lund.jpg"),
    new Member("Andreas Byskov", "System Architect", "img/members/andreas_byskov.jpg"),
    new Member("Jesper Flatheim", "Wiring Harness", "img/members/jesper_a_flatheim.jpg")
)),
new TeamGroup("IT", "it","img/groups/it.jpg", array( 
    new Member("Jan Markus Høie", "Group Leader IT", "img/members/jan_markus_hoie.jpg"),
    new Member("Andreas Lindemark", "Software Developer", "img/members/ion_stig.jpg"),
    new Member("Yohannes Dawit Kassaye", "Software Developer", "img/members/ion_stig.jpg"),
